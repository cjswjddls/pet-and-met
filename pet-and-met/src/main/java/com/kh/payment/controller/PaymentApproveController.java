...
public class PaymentApproveController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String msg = request.getParameter("omid");
		int memberNo = Integer.parseInt(msg.split("/")[1]);
		int oid = Integer.parseInt(msg.split("/")[0]);
