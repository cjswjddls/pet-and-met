	...
	<body>
		...
		<div class="img">
		    ...
		    <br>
		        ...
		        <table border="1">
		            <tr align="center">
		                <td colspan="3" rowspan="4" height="230" width="30%" style="border: 5px solid green;"><img src="<%= pagePath %>resources/img/intro/bono.jpg" width="100%"></img></td>
		        ...
		        <table border="1">
		            <tr align="center">
		                <td colspan="3" rowspan="4" height="230" style="border: 5px solid green;" width="30%" ><img src="<%= pagePath %>resources/img/intro/bono.jpg" width="100%"></img></td>
		                <td width="30%" height="30" style="border: 5px solid green;">타입</td>
