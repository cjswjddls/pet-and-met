...
/**
 * Servlet implementation class BoardSerachAjaxController
 */
@WebServlet("/board.search")
public class BoardSerachAjaxController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardSerachAjaxController() {
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Board> list = new BoardService().selectBoardAjax(pi, method, keyword);
